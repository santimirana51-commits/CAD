/* Nasjicad — icons2.js (owner: ICONS-A, SPEC3 §25)
 ...
 * Style per SPEC §6: original line art, viewBox 0 0 32 32, fill=none,
...
(() => {
  ...
  // Local copy of the icons.js svg wrapper (SPEC §6 — do not touch icons.js).
