/* Nasjicad — icons3.js (owner: ICONS-B, SPEC3 §26)
 ...
 * Style per SPEC §6: viewBox 0 0 32 32, fill=none, round caps/joins,
...
(() => {
  ...
  const P = {
    ...
    /* ---- View ▸ Palettes, and its slide-out ---- */
    ...
    /* ---- Express Tools ▸ Blocks slide-out: the nested-object family ---- */
    ...
    /* ---- Express Tools ▸ Modify slide-out ---- */
    ...
    /* ---- ARC flyout variants (SPEC3 §24) — one quarter-arc motif read three
  ...
  // Local copy of the SPEC §6 wrapper (icons.js is not edited).
