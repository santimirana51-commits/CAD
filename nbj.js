/* pixelbay CAD — nbj.js  (SPEC2 Â§18). Owner: FILEIO.
 ...
 *   [u32 LE count]     [count Ã— u32 LE seq]      [count encoded values]
 *
 ...
 *   8 pt2  {x,y}     2 Ã— f64   — the dominant shapes get their own tags:
 *   9 pt3  {x,y,z}   3 Ã— f64     a polyline vertex costs 17 bytes and one
 *  10 pt2b {x,y,b}   3 Ã— f64     allocation instead of an object header,
 ...
 * the input, no quadratic scans, so a machine NÃ— slower decodes exactly NÃ—
